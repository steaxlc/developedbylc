            ...
            <Glass>
                <DashBoard>
                    ...
                    <div className="information">
                        <div className="link">
                        <a target="_blank" href="https://github.com/steaxlc/"><FaGithub size="30"/> JLucianoCastro</a>
                        </div>
                        <div className="link">
                        <a target="_blank" href="https://www.linkedin.com/in/jlucianocastro/"><FaLinkedin size="30"/> sTeaxLC</a>
                        </div>
                        <div className="link">
